          ...
          return (
            ...
            >
              ...
              <div className="relative z-10 flex items-start gap-4">
                <div
                  className={`relative flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center shadow-lg transition-all duration-300 ${
                    isLocked
                  ...
                  <AnimatePresence>
                    {isExpanded && !isLocked && (
                      ...
                      >
                        ...
                        {phase.description && (
                          <div className={`ml-4 p-4 rounded-lg border-2 ${
                            phase.id === 1
                                ...
                                <div className="flex-1 min-w-0">
                                  ...
                                  {stage.anexos && stage.anexos.length > 0 && (
                                    <div className="mt-3 pt-3 border-t border-gray-200 dark:border-gray-700">
                                      ...
                                      {isGuest && visibilidadeAnexos === 'privado' ? (
                                        <div className="flex items-center gap-2 p-2 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg">
                                          ...
                                          {onLoginClick && (
                                            <button
                                              ...
                                              className="text-xs px-2 py-1 bg-amber-600 hover:bg-amber-700 text-white rounded font-semibold transition-colors"
                                            >
                                              Login
                                            </button>
                                          )}
