...
export function PhaseStatsCards({
  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
      {/* Ideação */}
      <div className="group relative bg-yellow-50 dark:bg-yellow-900/20 rounded-xl overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 cursor-pointer border border-yellow-200 dark:border-yellow-700">
        ...
        {/* Footer do card */}
        <div className="px-6 py-3 bg-yellow-100 dark:bg-yellow-900/30 border-t border-yellow-200 dark:border-yellow-800">
          <div className="flex items-center justify-start text-xs pl-0">
      ...
      {/* Modelagem */}
      <div className="group relative bg-blue-50 dark:bg-blue-900/20 rounded-xl overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 cursor-pointer border border-blue-200 dark:border-blue-700">
        {/* Barra colorida no topo */}
        ...
        {/* Footer do card */}
        <div className="px-6 py-3 bg-blue-100 dark:bg-blue-900/30 border-t border-blue-200 dark:border-blue-800">
          <div className="flex items-center justify-start text-xs pl-0">
      ...
      {/* Prototipagem */}
      <div className="group relative bg-purple-50 dark:bg-purple-900/20 rounded-xl overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 cursor-pointer border border-purple-200 dark:border-purple-700">
        {/* Barra colorida no topo */}
        ...
        {/* Footer do card */}
        <div className="px-6 py-3 bg-purple-100 dark:bg-purple-900/30 border-t border-purple-200 dark:border-purple-800">
          <div className="flex items-center justify-start text-xs pl-0">
      ...
      {/* Implementação */}
      <div className="group relative bg-green-50 dark:bg-green-900/20 rounded-xl overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 cursor-pointer border border-green-200 dark:border-green-700">
        {/* Barra colorida no topo */}
        ...
        {/* Footer do card */}
        <div className="px-6 py-3 bg-green-100 dark:bg-green-900/30 border-t border-green-200 dark:border-green-800">
          <div className="flex items-center justify-start text-xs pl-0">
