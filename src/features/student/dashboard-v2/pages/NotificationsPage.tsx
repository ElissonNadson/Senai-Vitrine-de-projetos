          ...
          <div className="flex items-center gap-2">
            {selectedIds.length > 0 && (
              <button
                ...
                className="flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-medium text-white bg-red-500 hover:bg-red-600 dark:bg-red-600 dark:hover:bg-red-700 rounded-xl transition-all shadow-sm hover:shadow-md backdrop-blur-sm"
              >
            ...
            {unreadCount > 0 && (
              <button
                ...
                className="flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-medium text-white bg-white/10 hover:bg-white/20 rounded-xl transition-all shadow-sm hover:shadow-md backdrop-blur-sm"
              >
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-medium transition-all ${isActive
                      ? 'bg-primary text-white shadow-md dark:bg-primary-light'
        ...
        {filteredNotifications.length === 0 ? (
          ...
          <div className="space-y-3">
            {filteredNotifications.map((notification) => (
              <div
                key={notification.id}
                className={`group bg-white dark:bg-gray-800 rounded-xl shadow-sm border transition-all hover:shadow-md relative ${!notification.read
              ...
              >
                <div className="flex gap-4 p-4">
                  ...
                  {/* Icon */}
                  <div className="flex-shrink-0 flex items-center">
                    <div className={`h-12 w-12 rounded-xl flex items-center justify-center transition-all ${!notification.read
