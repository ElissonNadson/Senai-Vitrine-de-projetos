...
import { Rocket, Upload, X, FileText, Video, Info, Check, Download, ChevronDown, LinkIcon } from 'lucide-react'
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
            Mostre os resultados e o impacto do projeto
          </p>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex justify-between items-center mt-2">
          <span className="text-xs text-gray-500 dark:text-gray-400 flex items-center gap-1">
            <Rocket className="w-3 h-3" /> Compartilhe seus resultados
          </span>
                            ...
                            <div className="space-y-2">
                              <div className="relative">
                                ...
                                <input
                                  ...
                                  className="w-full pl-10 pr-3 py-2.5 text-sm border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-800 dark:text-white focus:ring-2 focus:ring-green-500/20 focus:border-green-500 transition-all"
                                />
                              </div>
                              <button
