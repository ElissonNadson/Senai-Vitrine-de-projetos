    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <div className="relative bg-gray-100 rounded-lg p-0.5 flex">
            <button
              type="button"
            ...
            >
              <User className={`h-3.5 w-3.5 mr-1.5 ${formData.userType === 'aluno' ? 'text-blue-600' : 'text-gray-500'}`} />
            ...
            >
              <Users className={`h-3.5 w-3.5 mr-1.5 ${formData.userType === 'professor' ? 'text-green-600' : 'text-gray-500'}`} />
      ...
      <button
        ...
        className="w-full flex justify-center items-center py-2.5 px-4 border-2 border-gray-300 rounded-lg text-xs font-medium text-gray-700 bg-white hover:bg-gray-50 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 transition-all"
      >
      ...
      <div className="text-center p-3 bg-blue-50 rounded-lg border border-blue-200">
        ...
        <Link
          to="/register"
          className="inline-flex items-center px-5 py-2 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all shadow-md hover:shadow-lg text-xs"
        >
